...
const QUESTIONS = [
    ...
    {
        question: "מלבד סכום ההשקעה הראשוני, האם בכוונתך להשקיע כל חודש בחודשו סכום כסף חדש כדי להנות מאפקט הריבית דריבית?",
        serialNum: 3,
        num: "3",
        options: [
            "כן",
        ...
        hint: "ריבית דריבית מתקבלת כאשר הריבית שהרווחנו על כספי ההשקעות שלנו בשנה הראשונה מושקעת בחזרה וממשיכה לייצר לנו תשואה בשנים הבאות. בניגוד לריבית רגילה שאנו מקבלים רק על כספי הקרן הראשוניים, ריבית דריבית היא מהלך של צבירת ריביות – הריבית שהתקבלה עבור כספי הקרן המקורית יחד עם הריבית שנקבל כשנשקיע את הריבית הזו שוב.",
        ifAnswered: "כן",
        skip: 2,
    },
    {
    ...
    },
    {
        ...
        hint: "חשבון מסחר עצמאי זה למעשה חשבון שבו ניתן לקנות ולקנות ניירות ערך שונים. החברות שמציעות כיום חשבון מסחר עצמאי הם אקסלנס, מיטב דש טרייד עצמאי, אינטרקאטיב ברוקרס ו- IBI.",
        ifAnswered: false,
        skip: 1,
    },
    {
